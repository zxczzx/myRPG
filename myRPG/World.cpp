...
//GETTERS
std::shared_ptr<Player> World::getActor() {
	return player_;
}

std::shared_ptr<Loot> World::getLoot() {
	return loot_;
}

std::vector<std::shared_ptr<Character> > World::getCharacters() {
	return characters_;
}

std::vector<std::string> World::getSavedGames() {
	return savedGames_;
}
...
//SETTERS
void World::setActor(std::shared_ptr<Player> player) {
	player_ = player;
}

void World::setLoot(std::shared_ptr<Loot> myLoot) {
	loot_ = myLoot;
}

void World::setCharacters(std::vector<std::shared_ptr<Character> > enemiesList) {
	characters_ = enemiesList;
}

void World::setSavedGames(std::vector<std::string> games) {
	savedGames_ = games;
}
...
void World::setGraphic(Graphic graphic) {
	system("CLS");
